...
const displayPhones = (phones,dataLimit)=>{
    ...
    const noPhone = document.getElementById('d-no-found')
    if(phones.length === 0){
    ...
    phones.forEach(phone => {
        ...
        <div class="card p-4">
          ...
          <div class="card-body">
            ...
            <button onclick="loadPhoneDetails('${phone.slug}')" href="#" class="btn btn-primary"data-bs-toggle="modal" data-bs-target="#phoneModalLavel">Show Details</button>
          </div>
        </div>
     `;
